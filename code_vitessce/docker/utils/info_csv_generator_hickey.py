...
# Given data
image_urls = [ rf'https://storagetuzi.blob.core.windows.net/blobtuzi/hickey_vccf_data/Region_{region+1}_mask.pyramid.ome.tif' for region in range(64)]

region_names = [f"{region+1}" for region in range(64)]
