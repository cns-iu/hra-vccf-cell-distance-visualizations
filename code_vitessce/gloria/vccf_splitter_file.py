...
df_Region_1 = df_Region_1[["Centroid X µm", "Centroid Y µm", "Cell Type"]]

# rename column cell_type_A to Cell Type
df_Region_1.rename(columns={"Centroid X µm": "x"}, inplace=True)
df_Region_1.rename(columns={"Centroid Y µm": "y"}, inplace=True)
...
df_Region_1_vessel = df_Region_1.loc[df_Region_1["Cell Type"] == 'Endothelial Cell']
df_Region_1_immmune = df_Region_1.loc[df_Region_1["Cell Type"] != 'Endothelial Cell']
