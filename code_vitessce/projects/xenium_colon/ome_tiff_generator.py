...
nuclei_root_path = r"G:\HuBMAP\Xenium_colon_polyp\new_data\vitessce_raw"
...
# for i in {3..31}
# do
#   ./bftools/bfconvert -tilex 512 -tiley 512 -pyramid-resolutions 6 -pyramid-scale 2 -compression LZW /mnt/g/HuBMAP/Xenium_colon_polyp/new_data/vitessce_raw/Region_${i}_mask.ome.tif /mnt/g/HuBMAP/Xenium_colon_polyp/new_data/vitessce_raw/xenium_vccf_data/Region_${i}_mask.pyramid.ome.tif
# done
