...
for label in unique_regions:
    ...
    df_Region_1 = df_Region_1[["x", "y", "Cell Type", "Size"]]
    ...
    micro_per_pixel = 1.0  # Taking avg if both possibilities
    ...
    for i in tqdm(range(len(x_list)), desc="Processing"):
        ...
        min_dist = 300  # The distance can be atmost 1mm so that cells can get oxygen
        has_near = False
